...
const DEFINITIONS := [
	...
	{"id": "chemical-cabinet", "assetId": "furniture-chemical-cabinet", "name": "Locked Chemical Cabinet", "category": "Utility", "width": 2, "height": 1, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	...
	{"id": "dish-machine-high-temp", "assetId": "furniture-dish-machine-high-temp", "name": "High-Temperature Dish Machine", "category": "Utility", "width": 4, "height": 3, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	{"id": "dry-storage-rack", "assetId": "furniture-dry-storage-rack", "name": "Dry Storage Rack", "category": "Storage", "width": 3, "height": 1, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	{"id": "essential-cafe-two-top", "assetId": "furniture-essential-cafe-two-top", "name": "Essential Cafe Two-Top", "category": "Dining", "width": 2, "height": 2, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	...
	{"id": "linen-storage", "assetId": "furniture-linen-storage", "name": "Linen and Reset Cabinet", "category": "Service", "width": 2, "height": 1, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	{"id": "manager-console", "assetId": "furniture-manager-console", "name": "Live Operations Console", "category": "Office", "width": 3, "height": 2, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	{"id": "oak-two-top", "assetId": "furniture-oak-two-top", "name": "Oak Two-Top", "category": "Dining", "width": 2, "height": 2},
	{"id": "office-desk", "assetId": "furniture-office-desk", "name": "Owner's Operations Desk", "category": "Office", "width": 3, "height": 2, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	...
	{"id": "prep-table-refrigerated", "assetId": "furniture-prep-table-refrigerated", "name": "Refrigerated Prep Table", "category": "Kitchen", "width": 4, "height": 2, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	...
	{"id": "three-comp-sink", "assetId": "furniture-three-comp-sink", "name": "Three-Compartment Sink", "category": "Utility", "width": 4, "height": 2, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	{"id": "walkin-rack", "assetId": "furniture-walkin-rack", "name": "Walk-In Storage Rack", "category": "Storage", "width": 3, "height": 1, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	{"id": "walnut-four-top", "assetId": "furniture-walnut-four-top", "name": "Walnut Four-Top", "category": "Dining", "width": 3, "height": 3},
	{"id": "water-station", "assetId": "furniture-water-station", "name": "Filtered Water Station", "category": "Service", "width": 2, "height": 2, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
	{"id": "wet-floor-station", "assetId": "furniture-wet-floor-station", "name": "Spill Response Station", "category": "Utility", "width": 2, "height": 1, "placement": {"mount": "floor", "occupancy": "blocking", "serviceAccess": "adjacent"}},
...
const FLOOR_POSITIONS := {
	...
	"furniture-chemical-cabinet": Vector2i(16, 11),
	"furniture-commercial-chair": Vector2i(10, 6),
	"furniture-convection-oven": Vector2i(14, 16),
	"furniture-dish-machine-high-temp": Vector2i(10, 11),
	"furniture-dry-storage-rack": Vector2i(24, 8),
	"furniture-essential-cafe-two-top": Vector2i(24, 4),
	"furniture-expo-pass-heated": Vector2i(3, 14),
	"furniture-host-stand-pro": Vector2i(16, 6),
	"furniture-linen-storage": Vector2i(4, 1),
	"furniture-manager-console": Vector2i(18, 4),
	"furniture-oak-two-top": Vector2i(22, 6),
	"furniture-office-desk": Vector2i(11, 4),
	"furniture-plancha-commercial": Vector2i(18, 1),
	"furniture-pos-terminal": Vector2i(2, 12),
	"furniture-premium-chair": Vector2i(8, 12),
	"furniture-prep-table-refrigerated": Vector2i(14, 8),
	"furniture-server-station-pro": Vector2i(14, 12),
	"furniture-six-burner-range": Vector2i(20, 12),
	"furniture-three-comp-sink": Vector2i(18, 10),
	"furniture-walkin-rack": Vector2i(1, 8),
	"furniture-walnut-four-top": Vector2i(5, 16),
	"furniture-water-station": Vector2i(7, 1),
	"furniture-wet-floor-station": Vector2i(1, 1),
